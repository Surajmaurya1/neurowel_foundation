      ...
      <div className="grid md:grid-cols-2 gap-12 items-center">
        ...
        <div>
          ...
          <div className="mt-6 flex flex-wrap gap-3">
            ...
            <a
              href="/volunteer"
              className="px-6 py-3 rounded-lg text-lg font-medium border border-[var(--brand-600)] text-[var(--brand-600)] hover:bg-[var(--brand-600)] hover:text-white transition-all duration-300 shadow-sm"
            >
              Volunteer With Us
            </a>
            ...
            <a
              href="/partner"
              className="px-8 py-3 rounded-lg text-lg font-medium border border-[var(--brand-600)] text-[var(--brand-600)] hover:bg-[var(--brand-600)] hover:text-white transition-all duration-300 shadow-sm"
            >
              Partner With Us
            </a>
          </div>
